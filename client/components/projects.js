  ...
  return (
    <div className="section">
      ...
      <div className="project">
        <a href="https://github.com/justinontheinternet/game-plan">
      ...
      <div className="project">
        <a href="https://github.com/justinontheinternet/blog-app">
      ...
      <div className="project">
        <a href="https://github.com/justinontheinternet/pickmeup-ui">
      ...
      <div className="project">
        <a href="https://github.com/justinontheinternet/lend_tracker_app">
      ...
      <div className="project">
        <a href="https://github.com/justinontheinternet/rotten_mangoes">
      ...
      <div className="project">
        <a href="https://github.com/justinontheinternet/game/tree/twoop">
